            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/problem/update" method="post" class="form-horizontal" role="form">
                                    <input name="id" value="${problem.id}" type="hidden" />
                                    <div class="row">
                                        <!-- 第一列左列 -->
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <textarea name="title" placeholder="请输入题目内容，选项除外" id="title" class="col-xs-12 col-sm-10">${problem.title}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="chooseA" id="chooseA" value="${problem.chooseA}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该选项内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="chooseB" id="chooseB" value="${problem.chooseB}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该选项内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="chooseC" id="chooseC" value="${problem.chooseC}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该选项内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="chooseD" id="chooseD" value="${problem.chooseD}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该选项内容">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="chooseE" id="chooseE" value="${problem.chooseE}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该选项内容">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- 左列结束 -->
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <select name="majorId" id="majorId" class="width-80 chosen-select" style="display: none;">
                                                        <c:forEach var="major" items="${majorList}">
                                                            <c:choose>
                                                                <c:when test="${problem.majorCode == major.code}">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <select name="subjectId" id="subjectId" class="width-80 chosen-select" style="display: none;">
                                                        ...
                                                        <c:forEach var="subject" items="${subjectList}">
                                                            <c:choose>
                                                                <c:when test="${problem.subjectCode == subject.code}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="score" id="score" value="${problem.score}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入该题的分值">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input name="answer" id="answer" value="${problem.answer}" class="col-xs-10 col-sm-10" type="text" placeholder="请输入答案" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- 右列结束 -->
