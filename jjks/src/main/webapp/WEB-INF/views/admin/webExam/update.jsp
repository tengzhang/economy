            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/webExam/update" method="POST" class="form-horizontal"
                                      role="form">
                                    <input name="id" value="${webExam.id}" type="hidden" />
                                        ...
                                        <div class="col-sm-9">
                                            <select name="majorId" id="form-field-1" class="width-80 chosen-select"
                                                ...
                                                <c:forEach var="major" items="${majorList}">
                                                    <c:choose>
                                                        <c:when test="${webExam.majorCode == major.code}">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="subjectId" id="form-field-2" class="width-80 chosen-select"
                                                ...
                                                <c:forEach var="subject" items="${subjectList}">
                                                    <c:choose>
                                                        <c:when test="${webExam.subjectCode == subject.code}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="examTime" id="form-field-3" value="${webExam.examTime}"
