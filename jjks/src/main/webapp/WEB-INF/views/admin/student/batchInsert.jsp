            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="${website}/admin/student/batch/insert" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="id-input-file-1"
                                       class="control-label col-xs-12 col-sm-3 no-padding-right">批量增加考生：</label>

                                <div class="col-xs-12 col-sm-9">
                                    <input name="studentFile" type="file" id="id-input-file-1"/>
                                </div>
                            </div>
