            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/major/insert" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="name" class="col-xs-10 col-sm-6" type="text" placeholder="请输入专业名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="description" class="col-xs-10 col-sm-6" type="text" placeholder="请输入描述"></textarea>
                                        </div>
                                    </div>
