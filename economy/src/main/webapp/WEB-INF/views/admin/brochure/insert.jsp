                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="alert alert-info center">
                            <strong>招生简章正文请尽量使用微软雅黑字体。</strong>
                        </div>

                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/brochure/insert" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="article.title" class="col-xs-10 col-sm-6" type="text" placeholder="请输入标题">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <!-- 添加文字编辑 -->
                                            <div id="aceEditor" class="wysiwyg-editor"></div>
                                        </div>
                                    </div>
