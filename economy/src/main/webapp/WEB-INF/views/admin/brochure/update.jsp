            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/brochure/update" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="article.title" value="${article.title}" class="col-xs-10 col-sm-6" type="text" placeholder="请输入标题">
                                        </div>
                                    </div>
