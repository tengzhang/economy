            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/question/update" method="POST" class="form-horizontal"
                                      role="form">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="indexModuleId" class="chosen-select" data-placeholer="请选择">
                                                <c:forEach var="indexModule" items="${indexModuleList}">
                                                    <c:if test="${question.indexModuleId != indexModule.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="question" value="${question.question}" class="col-xs-10 col-sm-6" type="text" placeholder="请输入问题">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="answer" class="col-xs-10 col-sm-6" placeholder="请输入回答">${question.answer}</textarea>
                                        </div>
                                    </div>
