                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-sm-6 no-padding-left">
                                    <form action="${website}/admin/notice" method="get" class="form-horizontal" role="form">
                                ...
                                <div class="col-sm-6 no-padding-right">
                                    <a href="${website}/admin/notice/insert" class="btn btn-sm btn-primary pull-right">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                    ...
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="article" items="${articleList}" varStatus="status">
                                            <tr>
                                                <td class="center">
                                                    <label>
                                                        <input class="ace" type="checkbox" value="${article.id}">
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                <td>${status.count}</td>
                                                ...
                                                <td class="hidden-480">
                                                    <a href="${website}/admin/notice/view/${article.id}">点击查看</a>
                                                </td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a data-trigger="ajax" data-target="#ajax_target"
                                                           href="${website}/admin/notice/update/${article.id}"
                                                        ...
                                                        <a id="delete-confirm-${article.id}"
                                                           ...
                                                           href="${website}/admin/notice/delete/${article.id}"
                                ...
                                <ul class="pagination pull-right">
                                    <li class="prev">
                                        <a href="${website}/admin/notice/list?pageNo=${page.prevPage}&search=${search}">
                                    ...
                                    <c:forEach var="pageNo" items="${page.pageList}">
                                        <c:choose>
                                            <c:when test="${pageNo == page.currentPage}">
                                                <li class="active">
                                                    <a href="${website}/admin/notice/list?pageNo=${pageNo}&search=${search}">${pageNo}</a>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                                                <li>
                                    ...
                                    <li class="next">
                                        <a href="${website}/admin/notice/list?pageNo=${page.nextPage}&search=${search}">
...
<script type="text/javascript">
    ...
    $('#batchDel').on('click', function() {
        ...
        $.ajax({
            url: '${website}/admin/notice/batch/delete',
            type: 'post',
            data: {
                'ids': ids
            },
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        if(type == 1) {
                            ...
                            window.location.href='${website}/admin/notice';
                        }
                    }
                },
                {
