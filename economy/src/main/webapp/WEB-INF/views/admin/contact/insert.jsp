            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/contact/insert" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="address" class="col-xs-10 col-sm-6" type="text" placeholder="请输入通信地址">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="phone" class="col-xs-10 col-sm-6" type="text" placeholder="请输入联系电话">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="email" class="col-xs-10 col-sm-6" type="text" placeholder="请输入电子邮件">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="contactPeople" class="col-xs-10 col-sm-6" type="text" placeholder="请输入联系人">
                                        </div>
                                    </div>
