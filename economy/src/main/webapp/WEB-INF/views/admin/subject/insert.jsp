                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="alert alert-info center">
                            <strong>课程内容请尽量使用微软雅黑字体。</strong>
                        </div>

                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/subject/insert" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form">
