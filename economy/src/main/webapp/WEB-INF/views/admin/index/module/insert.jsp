            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form action="${website}/admin/index/module/insert" method="POST" class="form-horizontal"
                                      role="form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="name" class="col-xs-10 col-sm-5" type="text" placeholder="请输入名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input name="iconClass" type="hidden" />
                                        <label class="col-sm-3 control-label no-padding-right">
                                            图标： </label>

                                        <div class="col-sm-9">
                                            <i id="iconClass" class="hide"></i>
                                            <button type="button" class="btn btn-primary" id="bootbox-options">点击添加图标</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="sortNo" value="${sortNo}" class="col-xs-10 col-sm-5" type="text" />
                                        </div>
                                    </div>
