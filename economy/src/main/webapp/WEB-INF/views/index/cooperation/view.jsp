        ...
        <div class="col-md-12 md-margin-bottom-40">
            <div class="tag-box tag-box-v3">
                <div class="headline clearfix">
                    <h2><i class="icon-comment color-blue"></i>&nbsp;${indexModule.name}助学合作单位</h2>
                </div>

                <div class="margin-bottom-20 clearfix"></div>

                <!-- 具体内容 -->
                <center><h2>${cooperation.title}</h2></center>

                <div class="margin-bottom-20 clearfix"></div>

                <center>
                    <ul class="list-unstyled list-inline blog-info">
                        <li><i class="icon-calendar color-orange"></i> <fmt:formatDate value="${cooperation.publicTime}" pattern="yyyy-MM-dd" /> </li>
                    </ul>
                </center>
                ...
                <c:if test="${cooperation.hasAttachment == 1}">
                    <div class="tag-box">
                        <h3>
