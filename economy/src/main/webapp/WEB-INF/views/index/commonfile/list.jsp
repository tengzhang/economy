        ...
        <div class="col-md-9 md-margin-bottom-40">
            <div class="tag-box tag-box-v3">
                <div class="headline clearfix">
                    <h2><i class="icon-comment color-blue"></i>&nbsp;常用文件下载</h2>
                </div>
                ...
                <ul class="list-unstyled comment">
                    <%-- 循环开始 --%>
                    <c:forEach var="commonFile" items="${commonFileList}">
                        <li class="clearfix headline">
                            <i class="icon-circle color-orange"></i>&nbsp;
                            <a href="${website}/index/commonfile/${commonFile.id}" target="_blank">
                                &nbsp;${commonFile.name}
                            </a>
                        </li>
                    </c:forEach>
