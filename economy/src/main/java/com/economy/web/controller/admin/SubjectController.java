...
public class SubjectController extends AbstractController {
    ...
    public String list(@RequestParam(value = "pageNo", required = false) Integer pageNo,
        ...
        try {
            ...
            int dataCount = articleService.queryCountByCondition(ArticleTypeEnum.Subject.getType(), search);
            Pagination page = new Pagination(dataCount, this.pageSize, pageNo);
            List<Article> articleList = articleService.queryByCondition(page, search, ArticleTypeEnum.Subject.getType());
    ...
    public String insert(ArticleDto articleDto) {
        try {
            articleDto.getArticle().setType(ArticleTypeEnum.Subject.getType());
