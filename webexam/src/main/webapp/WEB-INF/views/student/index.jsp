                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            进入可以查看你的专业、课程、缴费情况以及成绩。
                                            <div class="space-4"></div>
                                            <div class="hr hr8 hr-double"></div>
                                            <div class="space-8"></div>
                                            <div class="clearfix">
                                                <a href="${website}/student/info" title="" class="btn btn-danger btn-sm pull-right"><i class="icon-hand-right"></i> 点击进入</a>
                                            </div>
                                        </div><!-- /widget-main -->
                                    </div><!-- /widget-body -->
                                </div>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="space-8"></div>
                                            <div class="clearfix">
                                                <a href="${lessonUrl}" title="" class="btn btn-warning btn-sm pull-right"><i class="icon-hand-right"></i> 点击进入</a>
                                            </div>
                                        </div><!-- /widget-main -->
                                    </div><!-- /widget-body -->
                                </div>
