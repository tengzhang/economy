                        ...
                        <div class="col-sm-4">
                            <div class="widget-main no-padding">
                                <div class="dialogs">
                                    ...
                                    <div class="itemdiv dialogdiv">
                                        <div class="user">
                                            <img src="${staticWebsite}avatars/avatar4.png" alt="John's Avatar">
                                        </div>
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="text">
                                                亲爱的考生，在该自考学习服务中心平台开放期间，可以进行不限次数的测试。当该平台关闭后，系统会取考生的最高分作为科目的平时成绩。
                                            </div>
                                        </div>
                                    </div>
                                </div>
